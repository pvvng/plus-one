    ...
    <main className="max-w-screen-sm mx-auto px-4 py-10 text-sm text-neutral-800 dark:text-neutral-200 leading-relaxed font-paperlogy min-h-screen">
      ...
      <section className="space-y-6">
        <article>
          ...
          <p>
            본 약관은 플러스원!(이하 "서비스")의 이용과 관련하여 이용자와 운영자
            간의 권리, 의무 및 책임사항을 규정함을 목적으로 합니다.
          </p>
        </article>

        <article>
          <h2 className="font-semibold text-base mb-2">2. 정의</h2>
          <p>
            본 약관에서 사용하는 용어의 정의는 다음과 같습니다. "이용자"란 본
            서비스에 접속하여 이 약관에 따라 서비스를 이용하는 자를 말합니다.
          </p>
        </article>
        ...
        <article>
          <h2 className="font-semibold text-base mb-2">4. 개인정보 보호</h2>
          <p>
        ...
        <article>
          <h2 className="font-semibold text-base mb-2">5. 이용자의 의무</h2>
          <p>
        ...
        <article>
          <h2 className="font-semibold text-base mb-2">6. 기타</h2>
          <p>
      ...
      <p className="mt-10 text-xs text-neutral-500">
        본 약관에 대한 문의는 gdongu093@gmail.com 으로 연락 주세요.
      </p>
    </main>
  );
}
